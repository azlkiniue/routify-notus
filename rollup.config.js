...
export default {
    ...
    plugins: [
        ...
        copy({
            targets: [
                { src: 'node_modules/@fortawesome/fontawesome-free/webfonts/*', dest: 'assets/fontawesome/webfonts' },
                { src: 'node_modules/@fortawesome/fontawesome-free/css/all.min.css', dest: 'assets/fontawesome/css' },
            ],
            copyOnce: true
        }),
